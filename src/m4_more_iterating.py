...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 5
    actual = count_positive_sines([0.00000000001, 3, 4, 5, 6, 7, 8, 9])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 0
    actual = sum_first_n([120, 48, -10, 50, 5], 0)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 158
    actual = sum_first_n([158, -158, 48, -10, 50, 5], 1)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
